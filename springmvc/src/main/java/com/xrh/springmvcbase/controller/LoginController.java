...
import com.xrh.springmvcbase.annotation.AnnoManageUtil;
import com.xrh.springmvcbase.model.UserInfo;
import com.xrh.springmvcbase.utils.CommonConstants;
import com.xrh.springmvcbase.utils.VerifyCodeUtils;
...
//    private IUserInfoService userInfoService;
    ...
    public String index(Model model){
        Map menu = AnnoManageUtil.getMenus("com.xrh.springmvcbase.controller");
...
//        JimDBClientFactory.getInstence().getJimClient().expire(jimDBKey, 60, TimeUnit.SECONDS);
    ...
    private String getJimDBKey(HttpServletRequest request){
