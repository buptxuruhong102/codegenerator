package com.xrh.springmvcbase.common.base;

import com.xrh.springmvcbase.common.jdbc.dialect.Dialect;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.CacheSqlGenerator;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.SpringNamedSqlGenerator;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.SqlGenerator;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.metadata.Column;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.metadata.MetadataCreateUtils;
import com.xrh.springmvcbase.common.jdbc.sqlgenerator.metadata.Table;
import com.xrh.springmvcbase.common.jdbc.support.OffsetLimitResultSetExtractor;
import com.xrh.springmvcbase.common.page.Page;
import com.xrh.springmvcbase.common.page.PageRequest;
import com.xrh.springmvcbase.utils.CollectionHelper;
import com.xrh.springmvcbase.utils.ObjectUtils;
import com.xrh.springmvcbase.utils.SqlRemoveUtils;
...
public abstract class BaseSpringJdbcDao<E,PK extends Serializable> extends JdbcDaoSupport implements EntityDao<E,PK>{
	...
	public Page pageQuery(String query,String countQuery,final PageRequest pageRequest,RowMapper rowMapper) {
		...
		String sql = query;//queryXsqlResult.getXsql();
//		Map acceptedFilters = queryXsqlResult.getAcceptedFilters();
		int pageSize = pageRequest.getPageSize();
		int pageNumber = pageRequest.getPageNumber();
		return pageQuery(sql, ObjectUtils.describe(pageRequest), totalCount, pageSize, pageNumber,rowMapper);
	}
	...
	private int queryTotalCount(String countQuery,Object filtersObject) {
		...
		String removedOrderByQuery = countQuery;//SqlRemoveUtils.removeOrders(countQueryXsqlResult.getXsql());
	...
	public boolean isUnique(E entity, String uniquePropertyNames) {
		...
		String tableName = getSqlGenerator().getTable().getTableName();
		String columnName = getSqlGenerator().getTable().getColumnByPropertyName(uniquePropertyNames).getSqlName();
		String sql = "select count(*) from " + tableName + " where 1=1 and " + columnName + "=:" + uniquePropertyNames;
        int num = this.queryTotalCount(sql, entity);
