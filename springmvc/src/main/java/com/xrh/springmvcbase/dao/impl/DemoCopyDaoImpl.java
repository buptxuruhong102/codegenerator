...
@Repository
public class DemoCopyDaoImpl extends BaseSpringJdbcDao<DemoCopy,java.lang.Integer> implements IDemoCopyDao<DemoCopy,java.lang.Integer>{
	...
	public Class getEntityClass() {
		return DemoCopy.class;
	}
	
	public void save(DemoCopy entity) {
	...
	public Page findPage(DemoCopyQuery query) {
		StringBuilder sql = new StringBuilder("select "+ getSqlGenerator().getColumnsSql("t") + " from demo_copy t where 1=1 ");
		if(query.getId() != null) {
