...
public class DemoDemo extends BaseEntity implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "DemoDemo";
	...
	public boolean equals(Object obj) {
		if(obj instanceof DemoDemo == false) return false;
		if(this == obj) return true;
		DemoDemo other = (DemoDemo)obj;
