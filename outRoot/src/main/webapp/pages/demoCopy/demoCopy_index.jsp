...
<script src="${ctx}/pages/demoCopy/demoCopy.js"></script>
                ...
                <div class="form-group">
                    <div class="col-sm-3">
                        <span class="input-group-btn">
                          	<button class="btn btn-success " type="button"  href="###" onclick="demoCopy.add(this)"><i class="fa fa-plus"></i>&nbsp;&nbsp;<span class="bold">新建</span> </button>
                        </span>
                    </div>
                    <div class="col-sm-9">
                    <form id="queryForm">
